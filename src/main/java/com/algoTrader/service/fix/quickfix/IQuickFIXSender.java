...
public interface IQuickFIXSender {
	...
	boolean sendToTarget(Message message, SessionID sessionID) throws SessionNotFound;

	/**
	 * Send a message to the session specified in the message's target
	 * identifiers.
	 */
	boolean sendToTarget(Message message, java.lang.String qualifier) throws SessionNotFound;

	/**
	 * Send a message to the session specified by the provided target company
	 * ID.
	 */
	boolean sendToTarget(Message message, java.lang.String senderCompID, java.lang.String targetCompID)
	 ...
	 */
	boolean sendToTarget(Message message, java.lang.String senderCompID, java.lang.String targetCompID,
			java.lang.String qualifier) throws SessionNotFound;
}
