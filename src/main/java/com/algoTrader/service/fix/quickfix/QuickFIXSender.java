...
public class QuickFIXSender implements IQuickFIXSender {
	...
	public boolean sendToTarget(Message message, String qualifier) throws SessionNotFound {
		return Session.sendToTarget(message, qualifier);
	}

	public boolean sendToTarget(Message message, String senderCompID, String targetCompID) throws SessionNotFound {
		return Session.sendToTarget(message, senderCompID, targetCompID);
	}

	public boolean sendToTarget(Message message, String senderCompID, String targetCompID, String qualifier)
