...
import com.algoTrader.service.fix.quickfix.CurrentFIXDataDictionary;
...
public class FIXMessageAugmentor_40 extends NoOpFIXMessageAugmentor {
	...
	private static String[] TT_APPLICABLE_MESSAGE_CODES = new String[] { MsgType.ADVERTISEMENT,
			MsgType.EXECUTION_REPORT, MsgType.ALLOCATION_INSTRUCTION_ACK, MsgType.ALLOCATION_INSTRUCTION };
	...
	/**
	 * MarketOnClose order handling: FIX up to 4.2 doesn't have
	 * {@link TimeInForce#AT_THE_CLOSE} so we need to check if the order is a
	 * market order and of {@link OrdType#MARKET} and modify it appropriately to
	 * set the OrdType to be {@link OrdType#MARKET_ON_CLOSE}
	 * 
