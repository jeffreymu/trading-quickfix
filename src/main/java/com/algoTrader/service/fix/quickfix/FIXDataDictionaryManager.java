...
/**
 * Singleton class that is a mapping of all {@link FIXVersion} to their
 * corresponding {@link quickfix.DataDictionary} classes.
 * 
 */
...
public class FIXDataDictionaryManager {
	 ...
	 */
	public static FIXDataDictionary initialize(FIXVersion version, String location)
			throws FIXFieldConverterNotAvailable {
	...
	/**
	 * Initializes the manager with the supplied table of FIX Versions and the
	 * URLs to their data dictionaries.
	 * 
	 * @param urlMap
	 *            The map with FIX Versions as keys and URLs to their data
	 *            dictionaries as values.
	 * 
	 * @throws FIXFieldConverterNotAvailable
	 *             if there were errors.
	 */
	public static void initialize(Map<FIXVersion, String> urlMap) throws FIXFieldConverterNotAvailable {
		synchronized (LOCK) {
	 ...
	 * 
	 * @param version
	 *            The FIX Version value.
	 * 
	 * @return the data dictionary instance for the supplied FIX version. Null,
	 *         if no data dictionary instance is available.
	 */
	...
	private static final HashMap<FIXVersion, FIXDataDictionary> fddMap = new HashMap<FIXVersion, FIXDataDictionary>();
