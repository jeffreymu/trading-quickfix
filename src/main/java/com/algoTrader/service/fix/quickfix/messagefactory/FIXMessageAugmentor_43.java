...
public class FIXMessageAugmentor_43 extends FIXMessageAugmentor_42 {
	private static String[] TT_APPLICABLE_MESSAGE_CODES = new String[] { MsgType.NEW_ORDER_MULTILEG,
			MsgType.MULTILEG_ORDER_CANCEL_REPLACE, MsgType.TRADE_CAPTURE_REPORT_REQUEST, MsgType.TRADE_CAPTURE_REPORT,
			MsgType.QUOTE_REQUEST_REJECT, MsgType.QUOTE_STATUS_REPORT, MsgType.MASS_QUOTE_ACKNOWLEDGEMENT,
			MsgType.ORDER_MASS_CANCEL_REQUEST, MsgType.ORDER_MASS_CANCEL_REPORT, MsgType.NEW_ORDER_CROSS,
			MsgType.CROSS_ORDER_CANCEL_REPLACE_REQUEST, MsgType.CROSS_ORDER_CANCEL_REQUEST };
	...
	/**
	 * As of FIX43, we no longer use {@link quickfix.field.ExecTransType} so
	 * override this method to not do anything
	 */
	...
	/**
	 * Undo the changes made in FIX_40 augmentor Starting with FIX.4.3, the
	 * {@link OrdType#MARKET_ON_CLOSE} is deprecated so we want to use
	 * {@link TimeInForce#AT_THE_CLOSE} instead
	 * 
	 * @param inMessage
	 * @return
	 */
