...
/**
 * Represents "custom" fields (i.e. non-predetermined fields) that can show up
 * in the list of orders These can appear only as integers, and their value are
 * treated as either ints, doubles or strings (catch-all) Ex:
 * Price,OrderQty,1324,Account
 * 
 */
