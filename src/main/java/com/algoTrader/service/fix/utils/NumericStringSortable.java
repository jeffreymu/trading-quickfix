...
/**
 * A wrapper for a string-typed Order ID that implements <code>Comparable</code>
 * and first attempts to compare Order IDs as numerics, falling back onto
 * alphanumeric comparison if either ID is not numerical.
 * 
 */
